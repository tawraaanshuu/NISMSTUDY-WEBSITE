(function () {
  ...
  async function load() {
    ...
    if (courseError || !course) {
      ...
      console.error('courses SELECT failed:', courseError);
      return;
    }
    ...
    if (quizError) {
      ...
      console.error('quizzes SELECT failed:', quizError);
      return;
    }
    ...
    renderQuizzes(course.slug, quizData, completedMockCount, session, inProgressMap);
  }
